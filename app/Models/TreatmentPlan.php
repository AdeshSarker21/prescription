...
class TreatmentPlan extends Model
{
    ...
    {
        static::creating(function (TreatmentPlan $model) {
            if (empty($model->slug)) {
    ...
    {
        return $this->belongsToMany(Prescription::class, 'prescription_treatment_plans', 'treatment_plan_id', 'prescription_id')
            ->withTimestamps();
    }
