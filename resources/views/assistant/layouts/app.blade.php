    ...
    <div x-data="{ sidebarOpen: false }" class="min-h-screen flex relative z-10">
        ...
        <aside class="fixed inset-y-0 left-0 z-30 w-64 glass-sidebar text-gray-800 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-auto print:hidden"
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <a href="{{ route('assistant.clinical-seals.index') }}" class="nav-item flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('assistant.clinical-seals.*') ? 'active bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:text-gray-800 hover:bg-white/40' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                    <span>Clinical Seals</span>
                </a>

                @if(auth()->user()->hasModulePermission('smart_serial', 'smart-serial-manage'))
                <a href="{{ route('assistant.smart-serial.dashboard') }}" class="nav-item flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('assistant.smart-serial.dashboard') ? 'active bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:text-gray-800 hover:bg-white/40' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                    <span>Smart Serial Dashboard</span>
                </a>
                <a href="{{ route('assistant.smart-serial.index') }}" class="nav-item flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('assistant.smart-serial.index') ? 'active bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:text-gray-800 hover:bg-white/40' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                    <span>Smart Serial Queue</span>
                </a>
                <a href="{{ route('assistant.smart-serial.add-serial') }}" class="nav-item flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('assistant.smart-serial.add-serial') ? 'active bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:text-gray-800 hover:bg-white/40' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg>
                    <span>Add Serial</span>
                </a>
                <a href="{{ route('assistant.smart-serial.history') }}" class="nav-item flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('assistant.smart-serial.history') ? 'active bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:text-gray-800 hover:bg-white/40' }}">
                ...
                @if(auth()->user()->hasModulePermission('smart_serial', 'smart-serial-manage'))
                <a href="{{ route('assistant.receptionist.smart-serial.index') }}" class="nav-item flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('assistant.receptionist.smart-serial.*') ? 'active bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:text-gray-800 hover:bg-white/40' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                    <span>Smart Serial (Reception)</span>
                </a>
                @endif
