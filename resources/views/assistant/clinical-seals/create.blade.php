...
@section('title', 'Add Clinical Seal')
...
@section('content')
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Add Clinical Seal</h1>
    </div>

    <div class="max-w-2xl">
        <div class="dashboard-card">
            <form method="POST" action="{{ route('assistant.clinical-seals.store') }}">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea name="details" rows="4"
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-white/60 text-sm focus:ring-2 focus:ring-indigo-300 focus:border-indigo-300 outline-none transition"
                        placeholder="Enter seal details (normal text, optional)">{{ old('details') }}</textarea>
                ...
                <div class="flex items-center gap-3 pt-5 border-t border-gray-100">
                    <button type="submit" class="btn-gradient">Create Seal</button>
