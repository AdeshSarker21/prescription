    ...
    <div x-data="{ sidebarOpen: false }" class="min-h-screen relative z-10">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 glass-sidebar text-white transform transition-transform duration-300 ease-in-out -translate-x-full lg:translate-x-0"
            ...
            <nav class="p-4 space-y-1 overflow-y-auto nav-scroll" style="height: calc(100vh - 4rem);">
                ...
                <a href="{{ route('admin.smart-serial-voice.index') }}" class="nav-item flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('admin.smart-serial-voice.*') ? 'active bg-indigo-500/10 text-indigo-400' : 'text-white/60 hover:text-white/80 hover:bg-white/5' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"/></svg>
                    <span>Voice Settings (TTS)</span>
                </a>
                <a href="{{ route('admin.modules.index') }}" class="nav-item flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('admin.modules.*') ? 'active bg-indigo-500/10 text-indigo-400' : 'text-white/60 hover:text-white/80 hover:bg-white/5' }}">
                ...
                <a href="{{ route('admin.chambers.index') }}" class="nav-item flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('admin.chambers.*') ? 'active bg-indigo-500/10 text-indigo-400' : 'text-white/60 hover:text-white/80 hover:bg-white/5' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    <span>Chambers</span>
                </a>
                <a href="{{ route('admin.addons.index') }}" class="nav-item flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('admin.addons.*') ? 'active bg-indigo-500/10 text-indigo-400' : 'text-white/60 hover:text-white/80 hover:bg-white/5' }}">
        ...
        <div class="flex-1 flex flex-col min-h-screen lg:pl-64">
            ...
            <footer class="glass-footer px-6 py-4">
                <div class="flex flex-col sm:flex-row justify-between items-center text-sm text-white/40">
                    ...
                    <p>Design and Develop by: <a href="https://happycoddingit.com" target="_blank" class="text-indigo-400 hover:text-indigo-300 font-medium">Happy Codding IT</a></p>
                </div>
            </footer>
        </div>
    </div>
