...
@section('title', 'Edit Assistant - ' . $assistant->name)
...
@section('content')
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-white/90">Edit Assistant</h1>
        <p class="text-sm text-white/50 mt-1">Update assistant account details.</p>
    </div>

    <div class="max-w-3xl glass-card-static p-6">
        <form method="POST" action="{{ route('admin.assistants.update', $assistant) }}">
            @csrf
            @method('PATCH')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name', $assistant->name) }}" required
                ...
                <div>
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email', $assistant->email) }}" required
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-white/70 mb-1">Password <span class="text-xs text-white/40">(leave blank to keep current)</span></label>
                ...
                <div>
                    ...
                    <input id="phone" type="text" name="phone" value="{{ old('phone', $assistant->phone) }}"
            ...
            <div class="mt-6 flex items-center gap-3">
                <button type="submit" class="btn-gradient">Update Assistant</button>
